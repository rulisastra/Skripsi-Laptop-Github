...
plt.plot(sigmas_1[0:3],label='sigma utama (mean)', marker='o', ls='-')
plt.plot(sigmas_2[0:3],label='sigma lain', marker='x', ls=None)
plt.plot(sigmas_3[0:3],label='sigma lain', marker='x', ls=None)
plt.title('SIGMAS')
