...
for i in range(epoch):
    ...
    while(index+batch_dim<=trainX.shape[0]):        
        ...
        K_inn = K*innovation
        w_concat_new = w_concat + np.dot(K,innovation) # k sebagai learning rate
        ...
        layer_h_deltas = layer_2_delta # for future
        context_layer = layer_2 # for prev.
...
plt.plot(trainY[300:500], c='r', marker='o', label='true') #testY[0:50] buat plotting coba liat di catatan
plt.plot(layer_2_value[300:500], c='g', marker='o', label='prediction')
...
dstat_train = dstat(trainY, layer_2_value)
print('Dstat :', dstat_train,)
