...
# =============================================================================
# data_coba = pd.read_csv('data_coba_1month.csv', engine='python', delimiter=';', decimal=",", header=None, names=['date','value'])
# data_coba['value'] = data['value'].values
# data_coba['value'] = data['value'].astype('float32')
