...
for i in range(epoch):
    ...
    while(index+batch_dim<=trainX.shape[0]):        
        ...
        synapse_h_update = np.dot(np.atleast_2d(context_layer).T,(layer_2_delta))
...
# =============================================================================
        ...
        layer_h_deltas = layer_2_delta
        context_layer = layer_2
...
plt.plot(mse1,label='Q = 1', marker='x')
plt.title('Loss (MSE)')
plt.xlabel('Epoch')
plt.ylabel('Loss (MSE)')
plt.legend()
