...
# 
#         #update weight
#         innovation = ((Y-layer_3).sum()/len(layer_3_error))
#         w_concat_new = w_concat * innovation
# 
#         #%%
#         # assign bobot
#         synapse_0 = w_concat_new[0:(input_dim*hidden_dim),0]
#         synapse_h = w_concat_new[(input_dim*hidden_dim):(input_dim*hidden_dim)+(hidden_dim*hidden_dim2),0]
#         synapse_1 = w_concat_new[(input_dim*hidden_dim)+(hidden_dim*hidden_dim2):w_concat_new.shape[0],0]
# 
#         #reshape balik bobot
